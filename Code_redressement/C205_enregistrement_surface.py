...
def main():
    ...
    results_df['step_x'] = results_df['step_x'] / Total_L
    results_df['step_x'] = results_df['step_x'] * total_value
    results_df['step_x'] += variable_to_add
    ...
    output_csv_path = r'C:\Users\dejon\OneDrive\master2\ORGUE\fichier_excel\results.csv'
    results_df.to_csv(output_csv_path, index=False)
    print(f"\nLe fichier CSV a été enregistré sous : {output_csv_path}")
